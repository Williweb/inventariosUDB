...
@section('title', 'Nuevo usuario — Inventarios UDB')

@section('page-title', 'Nuevo usuario')
@section('page-subtitle', 'Crear cuenta de acceso')
...
<div class="max-w-lg">
    ...
    <div class="bg-white rounded-2xl border border-gray-100 p-6">
        <form method="POST" action="/usuarios" class="space-y-4">
            @csrf
            ...
            <div>
                ...
                <input type="email" name="correo" value="{{ old('correo') }}" required maxlength="255"
                       class="w-full px-3.5 py-2.5 rounded-xl border border-gray-200 text-sm outline-none focus:border-orange-400 focus:ring-2 focus:ring-orange-100 transition"
            ...
            <div>
                ...
                <input type="password" name="clave" required maxlength="255"
                       class="w-full px-3.5 py-2.5 rounded-xl border border-gray-200 text-sm outline-none focus:border-orange-400 focus:ring-2 focus:ring-orange-100 transition"
