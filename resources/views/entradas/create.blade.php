...
@section('title', 'Nueva entrada — Inventarios UDB')
@section('page-title', 'Nueva entrada')
@section('page-subtitle', 'Registrar entrada de inventario')
...
<div class="max-w-lg">
    ...
    <div class="bg-white rounded-2xl border border-gray-100 p-6">
        <form method="POST" action="/entradas" class="space-y-4">
            @csrf
            ...
            <div>
                ...
                <input type="number" name="precio_unitario" value="{{ old('precio_unitario') }}" required min="0" step="0.01"
                       class="w-full px-3.5 py-2.5 rounded-xl border border-gray-200 text-sm outline-none focus:border-orange-400 focus:ring-2 focus:ring-orange-100 transition"
                       placeholder="0.00">
            </div>
            ...
            <div>
                ...
                <input type="text" name="proveedor" value="{{ old('proveedor') }}" required maxlength="150"
                       class="w-full px-3.5 py-2.5 rounded-xl border border-gray-200 text-sm outline-none focus:border-orange-400 focus:ring-2 focus:ring-orange-100 transition"
